...
namespace ExeCRUDWindowsForm
{
    public partial class Form3 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'rRQDataSet.Sena' table. You can move, or remove it, as needed.
            this.senaTableAdapter.Fill(this.rRQDataSet.Sena);
            this.senaTableAdapter.Fill(this.rRQDataSet.Sena);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dr[6] = textBox5.Text;
            dt.Rows.Add(dr);
            senaTableAdapter.Update(rRQDataSet);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            string code;
            code = textBox1.Text;
            dr = rRQDataSet.Tables["Sena"].Rows.Find(code);
            dr.Delete();
            senaTableAdapter.Update(rRQDataSet);
        }
    }
