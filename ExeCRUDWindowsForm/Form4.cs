...
namespace ExeCRUDWindowsForm
{
    public partial class Form4 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'rRQDataSet.Mika' table. You can move, or remove it, as needed.
            this.mikaTableAdapter.Fill(this.rRQDataSet.Mika);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dr[6] = textBox5.Text;
            dt.Rows.Add(dr);
            mikaTableAdapter.Update(rRQDataSet);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            string code;
            code = textBox1.Text;
            dr = rRQDataSet.Tables["Mika"].Rows.Find(code);
            dr.Delete();
            mikaTableAdapter.Update(rRQDataSet);
        }
    }
